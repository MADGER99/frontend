    ...
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='mt-20'>
          ...
          <div className='flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500'>
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis, soluta? Ad, asperiores? Minima, natus. Atque ex alias repudiandae totam iusto laboriosam? Facere, ad pariatur! Temporibus ut optio beatae cumque voluptatum.</p>
          </div>
      </div>
